const CACHE = 'zigs-fi-shell-v26';
const SHELL = ['./','./index.html','./src/styles.css?v=30','./src/app.js?v=30','./src/googleSheets.js?v=2','./src/utils.js','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2'];
