const CACHE = 'zigs-fi-shell-v44';
const SHELL = ['./','./index.html','./tutorial.html','./src/styles.css?v=39','./src/app.js?v=44','./src/utils.js?v=3','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2','./apps-script/Code.gs?v=5'];
