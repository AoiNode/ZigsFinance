const CACHE = 'zigs-fi-shell-v39';
const SHELL = ['./','./index.html','./tutorial.html','./src/styles.css?v=37','./src/app.js?v=40','./src/utils.js','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2','./apps-script/Code.gs?v=3'];
