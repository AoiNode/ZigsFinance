const CACHE = 'zigs-fi-shell-v40';
const SHELL = ['./','./index.html','./tutorial.html','./src/styles.css?v=38','./src/app.js?v=41','./src/utils.js?v=1','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2','./apps-script/Code.gs?v=3'];
