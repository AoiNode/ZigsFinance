const CACHE = 'zigs-fi-shell-v51';
const SHELL = ['./','./index.html','./tutorial.html','./src/styles.css?v=39','./src/app.js?v=49','./src/utils.js?v=3','./src/data-store.js?v=2','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2','./apps-script/Code.gs?v=8'];
