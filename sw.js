const CACHE = 'zigs-fi-shell-v29';
const SHELL = ['./','./index.html','./tutorial.html','./src/styles.css?v=31','./src/app.js?v=31','./src/utils.js','./manifest.webmanifest','./icons/icon-192.png?v=2','./icons/icon-512.png?v=2','./icons/icon-maskable-512.png?v=2','./apps-script/Code.gs?v=2'];
