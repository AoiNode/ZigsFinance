...
function renderSettings() {
  ...
  // Pengaturan cukup menampilkan lima aktivitas paling baru. Log lengkap tetap disimpan lokal
  // dan ikut mekanisme sinkron; ini hanya batas presentasi agar halaman tidak memanjang.
  const recentAuditLog = state.auditLog.slice(0, 5);
